...
> 2026-09-15T07:59:07+00:00 · corpus `f019591babf2941e` (2026.09.13) · commit `4047bb5` · Tesseract tesseract v5.5.0.20241111 · cego excluído

## Resumo por estrato

| estrato | n | resp. | abst. | revisão | CER médio | IC 95% | WER | lances | perdidos | inventados | ctrl FP | s/MP |
|---|--:|--:|--:|--:|--:|---|--:|--:|--:|--:|--:|--:|
| fax_dither | 63 | 63 | 0 | 0 | 0.0449 | 0.0298–0.0600 | 0.1279 | 0.7921 | 178 | 25 | 0/0 | 3.12 |
| native | 237 | 230 | 7 | 0 | 0.0921 | 0.0744–0.1109 | 0.2564 | 0.4348 | 477 | 292 | 0/9 | 2.32 |
| photo | 63 | 63 | 0 | 0 | 0.2004 | 0.1732–0.2286 | 0.2739 | 0.6706 | 282 | 22 | 0/0 | 1.70 |
| scan_clean_300 | 137 | 137 | 0 | 0 | 0.0330 | 0.0169–0.0546 | 0.0574 | 0.9324 | 124 | 14 | 0/0 | 0.64 |
| scan_degraded_150 | 137 | 137 | 0 | 0 | 0.0454 | 0.0265–0.0695 | 0.0920 | 0.8371 | 299 | 65 | 0/0 | 2.21 |
| shadow_curl_bleed | 101 | 101 | 0 | 0 | 0.0397 | 0.0280–0.0530 | 0.1060 | 0.9288 | 75 | 12 | 0/0 | 3.38 |
...
- Tempo total 340.28 s, 1.7187 s/MP.

## Portões

- ✗ **CER limpo** — 0.0625 em 2 estrato(s) limpo(s), limite 0.0050
